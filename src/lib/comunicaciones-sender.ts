    ...
    return `
      <div class="fc-bloque-portal" style="margin-top:8px;border:1px solid #dbeafe;background:#eff6ff;border-radius:10px;padding:18px 20px;">
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto;border-collapse:separate;">
          <tr><td class="fc-bloque-portal-cta" align="center" valign="middle" bgcolor="${escapeHtml(acento)}" style="border-radius:8px;padding:12px 22px;">
            <a href="${escapeHtml(urlPortal)}" style="color:#ffffff;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-weight:600;text-decoration:none;font-size:14px;line-height:1.2;display:inline-block;">Abrir mi Portal del Asegurado</a>
          </td></tr>
        </table>
      </div>
    `.trim()
      ...
      if (info.excedio_limite) {
        ...
        const linkHtml = info.url_portal
          ? `<p style="margin:12px 0 0;font-size:14px;color:#64748b;">Podés descargarlos desde tu Portal del Asegurado:</p>
             <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:12px auto 0;border-collapse:separate;">
               <tr><td align="center" valign="middle" bgcolor="${escapeHtml(colorBoton)}" style="border-radius:8px;padding:12px 22px;">
                 <a href="${escapeHtml(info.url_portal)}" style="color:#ffffff;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-weight:600;text-decoration:none;font-size:14px;line-height:1.2;display:inline-block;">Abrir mi Portal del Asegurado</a>
               </td></tr>
             </table>`
