...
export const CAMPOS_POR_BLOQUE: Record<BloqueId, CampoEspecifico[]> = {
  vehiculo_estacionado: [
    {
      ...
      requerido: true,
      opciones: ['No', 'Sí'],
      ayuda: 'Elegí "Sí" si nadie estaba conduciendo al momento del siniestro.',
    },
  ],
  ...
  conductor: [
    {
      ...
      label: '¿Quién conducía al momento del siniestro?',
      tipo: 'radio',
      requerido: true,
      opciones: ['El asegurado', 'Otra persona'],
    },
  ...
  tercero: [
    ...
    {
      key: 'motivo_sin_datos_tercero',
      label: '¿Por qué no cargás los datos del tercero?',
      tipo: 'radio',
      requerido: false,
      opciones: [
        'Se dio a la fuga o no se identificó',
        'No me brindó sus datos',
        'Los adjunto en la documentación',
      ],
      ayuda: 'Elegí una opción si no vas a completar los datos del tercero.',
    },
    {
      key: 'categoria',
  ...
  testigos: [
    {
      ...
      requerido: true,
      opciones: ['No', 'Sí'],
      ayuda: 'Podés cargar hasta 3 testigos si elegís "Sí".',
    },
