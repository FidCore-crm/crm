# Pulzar — CRM para Productores Asesores de Seguros
...
> Ver [LICENSE](./LICENSE) y [pulzar.com.ar](https://pulzar.com.ar).
...
Pulzar se distribuye como **appliance**: un mini-PC pre-configurado que
se instala en el escritorio del PAS o en su oficina. La instalación la
realiza Pulzar. El cliente recibe:
...
Para consultas comerciales: [pulzar.com.ar](https://pulzar.com.ar)
...
- **Licencias Ed25519 offline** (firma asimétrica) — sin servidor de
  licencias online, sin dependencia de Pulzar para operar.
...
Reportes de seguridad: [seguridad@pulzar.com.ar](mailto:seguridad@pulzar.com.ar).
...
Pulzar mediante el sistema de claves Ed25519 incluido.

---

© 2026 Pulzar. Todos los derechos reservados.
