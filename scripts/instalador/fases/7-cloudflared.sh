...
fase_cloudflared_ejecutar() {
  ...
  printf "     Domain:     ${C}fidcore.com.ar${R}\n"
  ...
  printf "  • CRM (para el PAS):                ${G}https://%s.fidcore.com.ar${R}\n" "$slug"
  printf "  • Formulario público de denuncia:   ${G}https://denuncia.%s.fidcore.com.ar${R}\n" "$slug"
  printf "  • Portal del Asegurado:             ${G}https://%s.fidcore.com.ar/c/<token>${R}\n" "$slug"
  echo ""
